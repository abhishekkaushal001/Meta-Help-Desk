...
const ChatPage = ({ page }: { page: PageData }) => {
  const { data, isLoading, error, isFetched, refetch } = useChats(page);
        ...
        <div className="grid grid-cols-5 w-full">
          ...
          <div className="col-span-3 bg-stone-200 border-x-[.5px] border-gray-300">
            <div className="flex bg-white align-middle px-3 py-4 border-b-[0.5px] border-gray-300">
              {!user && (
                <h2 className="font-bold text-xl pl-3 text-gray-300">
                  Messages
                </h2>
              )}
              {user && (
            ...
            <div className="flex px-4">
              <input
                ...
                placeholder={
                  user
                    ? `Message ${
                        data?.data.find((d) => d.id === user)?.participants
                          .data[0].name
                      }`
                    : "Message"
                }
